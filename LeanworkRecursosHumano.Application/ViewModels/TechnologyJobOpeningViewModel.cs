...
{
    public class TechnologyJobOpeningViewModel
    {
        public TechnologyJobOpeningViewModel(string titleJobOpening, string descriptionJobOpening, string nameTechnology, string descriptionTechnology, int idJobOpening, int idTechnology)
        {
